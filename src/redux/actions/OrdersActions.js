import { ADD_CUTOMER_DETAIL_FOR_ORDER, ADD_DELIVERY_DATE_FOR_ORDER, ADD_GEOLOCATION_FOR_ORDER, ADD_ISSUE_DATE_FOR_ORDER, ADD_PRODUCT_FOR_ORDER, ADD_QUANTITY_FOR_ORDER, ADD_SHOP_PICTURE_FOR_ORDER, PUSH_ORDER_TO_RECEIVED_LIST, RESET_PRODUCTS_FOR_ORDER, RESET_SHOP_PICTURE_FOR_ORDER, SUBMIT_ORDER } from "../types";

export const AddOrderCustomerDetails = (data) => {
    return {
        type: ADD_CUTOMER_DETAIL_FOR_ORDER,
        payload: data
    }
}
